...
from models.inf.dycontrolnet_inf import ControlNetModel
# from models.controlnet_wo_connection import ControlNetModel
from unets.inf.backbone_inf import UNet2DConditionModelDy as backbone
from unets.inf.unet2d_inf import UNet2DConditionModelDy as ctrlnet
...
class StableDiffusionControlNetPipeline(
    ...
    def __call__(
        ...
        height: Optional[int] = 512,  # None
        width: Optional[int] = 512,  # None
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                down_block_res_samples, mid_block_res_sample, up_block_res_samples = self.controlnet(
                    control_model_input,
                    t,
                ...
                noise_pred = self.unet(
                    ...
                    up_block_additional_residuals=up_block_res_samples,
