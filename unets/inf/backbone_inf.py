...
from unets.inf.downsampling_inf import get_down_block
# from unets.downsampling2 import get_down_block
from unets.inf.upsampling_inf import get_up_block  # use for backbone
# from unets.upsampling2 import get_up_block  # use for controlnet
...
class UNet2DConditionModelDy(
    ...
    def forward(
        ...
        is_controlnet = down_block_additional_residuals is not None and mid_block_additional_residual is not None and up_block_additional_residuals is not None
        if is_controlnet:
            if down_block_additional_residuals[0] != None:
                sample = sample + down_block_additional_residuals.pop(0)
            else:
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                sample, res_samples = downsample_block(
                    ...
                    conditional_ctrl=down_block_additional_residuals,
                    temb=emb,
                ...
                sample, res_samples = downsample_block(hidden_states=sample, conditional_ctrl=down_block_additional_residuals, temb=emb)
                if is_adapter and len(down_intrablock_additional_residuals) > 0:
        ...
        if is_controlnet and mid_block_additional_residual != None:
            if mid_block_additional_residual is not 0:
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                sample, _ = upsample_block(
                    hidden_states=sample,
                    conditional_ctrl=up_block_additional_residuals,
                    temb=emb,
