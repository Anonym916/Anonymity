...
# from unets.downsampling import get_down_block
from unets.inf.downsampling2_inf import get_down_block
# from unets.upsampling import get_up_block  # use for backbone
from unets.inf.upsampling2_inf import get_up_block  # use for controlnet
...
class UNet2DConditionModelDy(
    ...
    def forward(
        ...
        if is_controlnet:
            # pop down block conditional control from front to back
            #down_block_ctrl = down_block_additional_residuals[0]
            #down_block_additional_residuals = down_block_additional_residuals[1:]
            #sample = sample + down_block_ctrl
