...
from models.pipeline_dycontrolnet import StableDiffusionControlNetPipeline
...
def main(args):
    # stabilityai/stable-diffusion-1-5-base
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(controlnet):
                ...
                down_block_res_samples, mid_block_res_sample, up_block_res_samples, masks = controlnet(
                    noisy_latents,
                    timesteps,
                ...
                loss = F.mse_loss(model_pred.float(), target.float(), reduction="mean") + costloss(masks)
